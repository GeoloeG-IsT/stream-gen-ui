...
- Files: `frontend/app/flowtoken/page.tsx` (162 lines), `frontend/app/llm-ui/page.tsx` (160 lines), `frontend/app/streamdown/page.tsx` (160 lines)
...
- Files: `frontend/app/api/chat/route.ts` (line 70)
...
- Files: `frontend/app/api/chat/route.ts` (lines 54, 94)
...
- Files: `frontend/components/streamdown/StreamdownRenderer.tsx` (lines 62-78)
...
- Files: `frontend/components/flowtoken/FlowTokenRenderer.tsx` (38), `frontend/components/llm-ui/LLMUIRenderer.tsx` (49), `frontend/components/streamdown/StreamdownRenderer.tsx` (42), `frontend/app/flowtoken/page.tsx` (29)
...
- Files: `frontend/components/shared/MessageList.tsx` (15-30), `frontend/app/flowtoken/page.tsx` (89-109), `frontend/app/llm-ui/page.tsx`, `frontend/app/streamdown/page.tsx`
...
- Files: `frontend/app/api/chat/route.ts` (entire route implementation), all page components
...
- Files: `frontend/app/flowtoken/page.tsx` (35), using `useChat` from AI SDK
...
- Files: Only `frontend/app/api/chat/route.test.ts` (219 lines) covers API; NO tests for page components (`frontend/app/flowtoken/page.tsx`, `frontend/app/llm-ui/page.tsx`, `frontend/app/streamdown/page.tsx`)
...
- Files: `frontend/components/shared/ChatInput.tsx` (44), `frontend/app/flowtoken/page.tsx` (47)
...
- Files: `frontend/components/flowtoken/FlowTokenRenderer.tsx` (55), `frontend/components/llm-ui/LLMUIRenderer.tsx` (181), `frontend/components/streamdown/StreamdownRenderer.tsx` (203)
...
- Files: `frontend/components/shared/Header.tsx` (25, 44, 66)
...
- Files: `frontend/app/flowtoken/page.tsx` (147): `error.message || 'An error occurred while streaming the response.'`
...
- Files: `frontend/app/api/chat/route.ts` (136-151) - infinite delays possible
